/* ============================================================
   STAGE 1 — RPG COLOR ENGINE ("World")
   ------------------------------------------------------------
   This is the original animated-color engine (palettes / RGB
   base layer) ported unchanged in behavior from the source
   lighting-engine prototype, minus the fractal overlay layer.

   Contract for a "World":
     ...
     - a World has no idea who consumes its output. Kaleidoscope
       (Stage 3) just takes whatever canvas a World rendered into.

   This shape is intentional: future Worlds (Plasma, Fire, Clouds,
   Water, Nebula, ...) only need to implement update()/render()
   with this same signature to be swappable in main.js.
   ============================================================ */
